...
//		cancelScanButton = (Button) this.findViewById(R.id.btn_cancel_scan);
        ...
        runOnUiThread(new Runnable()
        {
            ...
            public void run()
            {
                ...
                if (result != null)
                {
                    ...
                    bundle.putString(RC.activity_qrscan.INTENT_EXTRA_KEY_SCAN, result.getText());
    ...
    protected void onResume()
    {
        ...
        //quit the scan view
//		cancelScanButton.setOnClickListener(newdata OnHtmlTagClickListener() {
//
//			@Override
...
//		});
    ...
    public void handleDecode(Result result, Bitmap barcode)
    {
        ...
        } else
        {
            Intent resultIntent = new Intent();
            Bundle bundle = new Bundle();
            bundle.putString(RC.activity_qrscan.INTENT_EXTRA_KEY_SCAN, resultString);
